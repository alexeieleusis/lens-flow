...
const plugin: {
  ...
  rules: {
    ...
    "no-abstract-class-without-concrete-methods":
      noAbstractClassWithoutConcreteMethods,
    ...
    "no-conflicting-intersection-properties":
      noConflictingIntersectionProperties,
    ...
    "no-excessively-nested-conditional-types":
      noExcessivelyNestedConditionalTypes,
    ...
    "no-nested-generics-without-extraction-uc14":
    ...
    "no-object-freeze-without-readonly-annotation":
      noObjectFreezeWithoutReadonlyAnnotation,
    ...
    "no-overengineered-intersection-constraint":
      noOverengineeredIntersectionConstraint,
    ...
    "no-private-constructor-unvalidated-factory":
      noPrivateConstructorUnvalidatedFactory,
    ...
    "no-runtime-string-concat-for-typed-keys":
      noRuntimeStringConcatForTypedKeys,
    "no-scattered-brand-cast": noScatteredBrandCast,
    "no-sealed-interface-without-evolution-path":
      noSealedInterfaceWithoutEvolutionPath,
    ...
    "no-shallow-readonly-mutable-collection":
      noShallowReadonlyMutableCollection,
    ...
    "no-string-discriminant-instead-of-union":
      noStringDiscriminantInsteadOfUnion,
    "no-string-match-error-handling": noStringMatchErrorHandling,
    "no-string-param-with-literal-comparison":
      noStringParamWithLiteralComparison,
    ...
    "prefer-explicit-interface-annotation-t59":
      preferExplicitInterfaceAnnotationT59,
    "prefer-function-property-over-method": preferFunctionPropertyOverMethod,
    "prefer-instanceof-over-constructor-name":
      preferInstanceofOverConstructorName,
    "prefer-interface-over-inline-generic": preferInterfaceOverInlineGeneric,
    "prefer-interface-over-pure-abstract-class":
      preferInterfaceOverPureAbstractClass,
    ...
    "prefer-record-over-literal-object-union":
      preferRecordOverLiteralObjectUnion,
    ...
    "prefer-switch-exhaustive-over-fallback-uc03":
      preferSwitchExhaustiveOverFallbackUc03,
    ...
    "require-explicit-generic-in-promise-chain":
      requireExplicitGenericInPromiseChain,
    "require-explicit-variance": requireExplicitVariance,
    "require-generic-coupling-for-shared-union":
      requireGenericCouplingForSharedUnion,
