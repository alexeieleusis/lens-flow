  ...
  meta: {
    ...
    messages: {
      sharedUnionWithoutGeneric:
        "Parameters {{params}} share the same union type {{union}} without a shared generic type parameter. Use a generic type variable to couple them. See: https://raw.githubusercontent.com/jpablo/vibe-types/refs/heads/main/plugin/skills/typescript/catalog/T04-generics-bounds.md",
    },
    schema: [],
    fixable: undefined,
  },
