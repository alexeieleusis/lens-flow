  ...
  meta: {
    ...
    messages: {
      validationInIterator:
        "Validation logic inside iterator callback. Domain invariants should be enforced by smart constructors, not checked at use sites. See: https://raw.githubusercontent.com/jpablo/vibe-types/refs/heads/main/plugin/skills/typescript/usecases/UC02-domain-modeling.md",
    },
    schema: [],
    fixable: undefined,
  },
