...
const DOCS_URL =
  "https://raw.githubusercontent.com/jpablo/vibe-types/7891def9e1b66bebd95a393b42f3401eba697cd5/plugin/skills/typescript/catalog/T49-associated-types.md";
...
export default createRule({
  ...
  create(context: TSESLint.RuleContext<"inferFromUnconstrained", []>) {
    ...
    return {
      ...
      TSClassDeclaration(node) { enterScope(node); },
      "TSClassDeclaration:exit"(node) { exitScope(node); },
