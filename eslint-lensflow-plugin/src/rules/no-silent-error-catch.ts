...
export default createRule({
  ...
  meta: {
    ...
    messages: {
      silentErrorCatch:
        "Error is only logged to console and replaced with a generic Error, losing original error details. Preserve or rethrow the original error. See: https://raw.githubusercontent.com/jpablo/vibe-types/refs/heads/main/plugin/skills/typescript/usecases/UC21-async-concurrency.md",
    },
    schema: [],
  },
  defaultOptions: [],
