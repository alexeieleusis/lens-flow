...
export default createRule({
  ...
  meta: {
    ...
    messages: {
      doubleCastAny:
        "Double-cast through `any` bypasses structural type checking. Use a single `as` cast or a type guard instead. See: https://raw.githubusercontent.com/jpablo/vibe-types/7891def9e1b66bebd95a393b42f3401eba697cd5/plugin/skills/typescript/catalog/T47-gradual-typing.md",
    },
    schema: [],
    fixable: undefined,
  },
