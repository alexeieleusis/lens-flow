  ...
  meta: {
    ...
    messages: {
      truthinessNullNarrowing:
        "Using truthiness check on a variable whose type includes null/undefined and falsy values (0, \"\", false). Use !== null or != null instead. See: https://raw.githubusercontent.com/jpablo/vibe-types/refs/heads/main/plugin/skills/typescript/catalog/T14-type-narrowing.md",
    },
    schema: [],
  },
  defaultOptions: [],
