...
const URL = knowledgeUrl("usecases/UC13-state-machines.md", "Antipatterns with Other Techniques (where State Machines Help) > Antipattern 4: Mutable state object with runtime guards");
