...
const DOCS_URL = knowledgeUrl("catalog/T33-self-type.md", "9. Common Type-Checker Errors > `error TS2677: A type predicate's type must be assignable from its parameter type`");
