...
export default createRule({
  ...
  meta: {
    ...
    messages: {
      optionalFields:
        "Found {{optionalCount}} optional fields out of {{totalCount}} total. Consider using a discriminated union to represent mutually exclusive states. See: https://raw.githubusercontent.com/jpablo/vibe-types/7891def9e1b66bebd95a393b42f3401eba697cd5/plugin/skills/typescript/usecases/UC01-invalid-states.md",
    },
    schema: [
      {
        type: "object",
