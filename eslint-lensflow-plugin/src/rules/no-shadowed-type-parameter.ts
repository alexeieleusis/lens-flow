...
const URL = knowledgeUrl("catalog/T04-generics-bounds.md", "### `Cannot find name 'T'` inside a class body");
...
export default createRule({
  ...
  meta: {
    ...
    messages: {
      shadowedTypeParam:
        "Type parameter '{{name}}' shadows an outer type parameter of the same name. Rename it to a distinct identifier. See: {{url}}",
    },
    schema: [],
    fixable: undefined,
  },
