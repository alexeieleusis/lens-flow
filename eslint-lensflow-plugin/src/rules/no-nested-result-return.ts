...
export default createRule({
  ...
  meta: {
    ...
    messages: {
      nestedResult:
        "Nested {{outer}}<...{{inner}}<...>> return type requires double unwraps. Flatten to a single-level error union instead. See: https://raw.githubusercontent.com/jpablo/vibe-types/7891def9e1b66bebd95a393b42f3401eba697cd5/plugin/skills/typescript/usecases/UC08-error-handling.md",
    },
    schema: [],
    fixable: undefined,
  },
